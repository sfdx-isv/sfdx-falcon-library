...
import {AnyConstructor}   from  '@sfdx-falcon/types';   // Interface. Represents the request body required to create a Bulk API 2.0 job.
 ...
 */
// ────────────────────────────────────────────────────────────────────────────────────────────────┘
export function chooseListrRenderer():AnyConstructor|string {
